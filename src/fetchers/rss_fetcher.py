...
class RSSFetcher:
    ...
    async def fetch(self) -> List[Article]:
        ...
        feed = await loop.run_in_executor(
            ...
            self._parse_feed_with_ssl_workaround,
            self.feed_url,
        )
    ...
    def _parse_feed_with_ssl_workaround(self, url: str):
        """Parse feed with SSL verification disabled (for development).

        Fetches the feed content first with an unverified SSL context,
        ...
        # Fetch content with unverified context
